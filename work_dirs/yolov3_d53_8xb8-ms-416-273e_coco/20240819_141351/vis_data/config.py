...
test_evaluator = dict(
    ann_file="/home/khointn/od_adversarial_attacks/results/ebad/coco_victim_YOLOv3_nwb1_iters1_iterw1_linf10_alphax3_lr0.01_YOLOv3annotations/instances_val2017.json",
    backend_args=None,
    metric="bbox",
    type="CocoMetric",
)
